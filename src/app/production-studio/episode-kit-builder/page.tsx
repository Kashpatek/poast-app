...
import EpisodeKitBuilder from "../episode-kit-builder";
...
export default function EpisodeKitBuilderPage() {
  ...
  return (
    <ProductionStudioShell title="Episode Kit Builder" subtitle="Transcript → show notes, chapters, clips, thank-you">
      <EpisodeKitBuilder />
