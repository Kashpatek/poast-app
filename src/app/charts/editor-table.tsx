...
// TableEditor · Checkpoint 1 stub. Replaced in Checkpoint 3 by the real
// DataSheetGrid + Univer integration.

import { D, ft, gf, mn } from "./studio-theme";
import { StudioDoc } from "./studio-types";

export default function TableEditor({ doc, onChangePayload }: {
  doc: StudioDoc;
  ...
  return (
    <div style={{ maxWidth: 980, margin: "0 auto", padding: "48px 28px" }}>
      <div style={{
        ...
        border: "1px dashed " + D.teal + "55",
        borderRadius: 16,
        textAlign: "center",
        boxShadow: "0 12px 36px rgba(0,0,0,0.4)",
      }}>
        <div style={{
          fontFamily: mn, fontSize: 10, color: D.teal, letterSpacing: 2,
          fontWeight: 700, textTransform: "uppercase", marginBottom: 10,
        }}>table editor · placeholder</div>
        <h3 style={{
        ...
        <p style={{
          ...
          lineHeight: 1.5,
        }}>Table editor (DataSheetGrid + Univer Excel Suite) lands in Checkpoint 3.</p>
      </div>
    </div>
  );
}
