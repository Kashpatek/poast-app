...
export const TABLE_TEMPLATES: TableTemplate[] = [
  ...
  },
  {
    id: "pricing",
    label: "Pricing tiers",
    blurb: "Plan × feature · top-3 medal tints",
    accent: SA.amber,
    glyph: "★",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    ...
    blurb: "Dense vendor scan · light theme",
    accent: SA.violet,
    glyph: "▣",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    ...
    blurb: "Highlight row · totaled rollup",
    accent: SA.coral,
    glyph: "↓",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    ...
    blurb: "Color-banded headers · pass/fail",
    accent: SA.amber,
    glyph: "✓✗",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    id: "ladder",
    label: "Tier ladder",
    blurb: "Medal tints · top categories first",
    accent: SA.violet,
    glyph: "T6",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    ...
    blurb: "Dense gen-over-gen · light theme",
    accent: SA.blue,
    glyph: "→→",
    build: () => ({
      engine: "standard",
  ...
  // — Chip/system templates per gap analysis —
  {
    id: "spec-compare",
    label: "Spec comparison",
    blurb: "Banded sections · spec grid",
    accent: SA.blue,
    glyph: "▤",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    ...
    blurb: "Color-banded headers · status pills",
    accent: SA.violet,
    glyph: "▩",
    build: () => ({
      engine: "standard",
  ...
  },
  {
    id: "leaderboard",
    label: "Leaderboard",
    blurb: "Top 3 medal tints · share + delta",
    accent: SA.amber,
    glyph: "①②③",
    build: () => ({
      engine: "standard",
