...
{id:"sa-aws-duo",guest:"Rachel Zheng & Karthik Venna",company:"Amazon AWS",title:"",host:"Wega Chu",tier:1,tag:"Cloud/Infra",slot:0,status:"scheduled",virtual:false,received:true,scheduled:false,notes:"Recorded at GTC 2026. Duo interview — two AWS guests, one episode. Next release. TODO(akash): add titles, bios, topics.",bio:"",companyDesc:"AWS. Trainium, Inferentia, largest cloud platform.",logo:"https://logo.clearbit.com/aws.amazon.com",topics:""},
];
...
export default function GTCFlow(){
  ...
  function mergeWithInit(stored: Episode[]): Episode[] {
    var STALE_IDS: Record<string, boolean> = { "sa-13": true, "sa-2": true, "sa-karthik-aws": true };
